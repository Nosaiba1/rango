...
def populate():
    ...
    python_pages = [
        {"title": "Official Python Tutorial",
         "url": "http://docs.python.org/2/tutorial/", "views": 41},
        {"title": "How to Think like a Computer Scientist",
         "url": "http://www.greenteapress.com/thinkpython/", "views": 12},
        {"title": "Learn Python in 10 Minutes",
         "url": "http://www.korokithakis.net/tutorials/python/", "views": 65}]
    ...
    pascal_pages = [{"title": "bla1", "url": "http://bla.com", "views": 999}]
    perl_pages = []
    php_pages = []
    prolog_pages = []
    postScript_pages = []
    ...
    cats = {"Python": {"pages": python_pages, "views": 128, "likes": 64},
            ...
            "Pascal": {"pages": pascal_pages, "views": 999},
